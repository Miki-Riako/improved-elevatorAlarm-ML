...
{
    //箭头在左
    public class ReComparer : IComparer<Rect>
    {
        //对x进行比较
    ...
    //箭头在上
    public class ReComparer1 : IComparer<Rect>
    {
        float[] c;
    ...
    public class NixieTubeIdentification2
    {
       /* static void Main(string[] args)
        ...
        //D:\BaiduNetdiskDownload\test1.mp4
        /* static void Main(string[] args)
         {
        ...
        public List<Mat> setMatImage1(Mat src, float[] c, float[] d)
        {
            ...
            try
            {
                ...
                Cv2.WarpAffine(srcGaussianBlur, srcGaussianBlur, affineTrans, srcGaussianBlur.Size(),
