...
{
   public  class ElevatorAlarmOcr_Frame20210326
    {
 ...
 */
        ...
        /*     static void Main(string[] args)
             {
                 ...
                 ElevatorAlarmOcr_Frame20210326 AS3 = new ElevatorAlarmOcr_Frame20210326();
                 CannyBackgroundModeling2 CBM = new CannyBackgroundModeling2();
                 backgroundModele = CBM.BackgroundModeling(filename1, e);
                 string Secret = "@g5#*$y980{_";
     ...
     */
        ...
        //    while (capture.Read(video))
        //    {
        //        AS3.Fun_StraightLadderTrappedPeopleMonitoring_V1(video, backgroundModele,
        //            backgroundModeleTemp, a, b, c, d, e, f, currentDigital, bodyNum);
        //        Cv2.ImShow(" video", video);
        //        Cv2.WaitKey(10);
        //    }
        //}
        ...
        public float[] Fun_StraightLadderTrappedPeopleMonitoring_V1(Mat video,
           ...
           float[] f, float[] currentDigital,string[] bodyNum)
        {
            //bodyNum
            //bodyNum[0]:String api_key= "";
            //bodyNum[1]:String secret_key= "";
            ...
            //以下为调试参数
            int detectionSettingValu e = 10;//载人检测设定的阈值
            ...
            if (timeInt1 < 20230101)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (c[14] == 1)
                        {
                            Console.WriteLine("电梯——上——行￥￥￥￥￥￥￥￥￥￥￥￥" + (int)c[14]);
                        }
                        else if(c[14]==-1){
                            Console.WriteLine("电梯——下——行￥￥￥￥￥￥￥￥￥￥￥￥" + (int)c[14]);
                        }
        ...
        /*        public float[] Fun_StraightLadderTrappedPeopleMonitoring_V1(Mat video,  HashSet<Coordinate> backgroundModele,
                    HashSet<Coordinate> backgroundModeleTemp, 
                    float[] a, float[] b, float[] c, float[] d, float[] e, float[] f, float[] currentDigital, string[] bodyNum)
                {

                    float[] elevatorStatus = new float[5];
                    ...
                    *//*
                    ...
                    elevatorStatus[0] = c[13];//楼层信息，初始化为-10；
                    elevatorStatus[1] = c[14];//箭头信息，初始化为-10；-1电梯向下运行,1电梯向上运行
                    elevatorStatus[2] = a[6] >= 3 ? 1 : 0;//门状态1为开0为关
                    elevatorStatus[3] = e[3] > detectionSettingValue ? 1 : 0;//1代表有人，0代表无人
                                                                             //elevatorStatus[4]=1困人，0正常
                    elevatorStatus[5] = int.Parse(bodyNum[2]);
